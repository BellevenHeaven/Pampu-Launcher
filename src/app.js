 ...
 */
 ...
 const clientId = '1098048250214371400';
 ...
 async function setActivity() {
    if (!RPC) return;
    RPC.setActivity({
        details: `Jugando Squid 2`,
        startTimestamp: Date.now(),
        largeImageKey: 'pampu_studios',
        largeImageText: `Pampu-Launcher`,
        instance: false,
        buttons: [
            {
                label: `Discord Pampu Studios`,
                url: `https://discord.gg/sH4qnyeu7u`,
            }
        ]
    });
 };
...
if (dev) {
    let appPath = path.resolve('./AppData/WindowsData').replace(/\\/g, '/');
