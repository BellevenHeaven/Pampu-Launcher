...
class Home {
                ...
                blockNews.innerHTML = `
                    <div class="news-header">
                        <div class="header-text">
                            <div class="title">Launcher funcionando!.</div>
                        </div>
                    </div>
    ...
    async dynmapbtn() {
        document.querySelector('.dynmap').addEventListener('click', async() => {
            require('electron').shell.openExternal("https://discord.gg/sH4qnyeu7u")
        })}
    ...
    async websitebtn() {
        document.querySelector('.web').addEventListener('click', async() => {
            require('electron').shell.openExternal("https://www.youtube.com/watch?v=ezWxxbLQxLM")
        })}
