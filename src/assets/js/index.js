...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Descargando la instancia...", "author": "Belleven" },
            { "message": "Cargando Configuraciones...", "author": "Belleven" },
            { "message": "Cargando Launcher...", "author": "Belleven" }
        ]
    ...
    async checkUpdate() {
        ...
        ipcRenderer.on('updateAvailable', () => {
            this.setStatus(`El launcher necesita actualizar algunas instancias`);
            this.toggleProgress();
